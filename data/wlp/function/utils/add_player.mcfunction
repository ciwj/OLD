...
$execute as $(username)[scores={lives=4..}] unless score $gameState gameState matches 0 run team join wlp.darkgreen @s 
# Announce life count
$execute as $(username)[scores={lives=4..}] unless score $gameState gameState matches 0 run title @s subtitle ["You have ",{"color":"dark_green","score":{"name":"@s","objective":"lives"}}," lives"]
$execute as $(username)[scores={lives=3}] unless score $gameState gameState matches 0 run title @s subtitle ["You have ",{"color":"green","score":{"name":"@s","objective":"lives"}}," lives"]
$execute as $(username)[scores={lives=2}] unless score $gameState gameState matches 0 run title @s subtitle ["You have ",{"color":"yellow","score":{"name":"@s","objective":"lives"}}," lives"]
$execute as $(username)[scores={lives=1}] unless score $gameState gameState matches 0 run title @s subtitle ["You have ",{"color":"red","score":{"name":"@s","objective":"lives"}}," lives"]
